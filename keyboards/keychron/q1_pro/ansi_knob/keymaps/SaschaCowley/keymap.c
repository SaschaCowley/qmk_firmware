...
void tap_dance_media(tap_dance_state_t *state, void *data) {
    switch (state->count) {
        case 1:
...
tap_dance_action_t tap_dance_actions[] = {
    [TD_KNOB_BUTTON] = ACTION_TAP_DANCE_FN(tap_dance_media),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [MAC_BASE] = LAYOUT_ansi_82(
    ...
    [WIN_BASE] = LAYOUT_ansi_82(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_INS,             TD(TD_KNOB_BUTTON),
